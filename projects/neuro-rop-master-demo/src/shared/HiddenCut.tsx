...
export const HiddenCut: React.FC<{fromSrc: string; toSrc: string; cut?: number; caption?: React.ReactNode}> = ({fromSrc, toSrc, cut = 103, caption}) => {
